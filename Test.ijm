...
#@ String (choices={"Max Intensity", "Option 2", "Option 3"}, style="listBox") pTypechoice
#@ Integer (value=100) conf
#@ String (choices={"Option A", "Option B"}, style="radioButtonHorizontal") options
#@ String (choices={"Option A", "Option B"}, style="radioButtonHorizontal") radios
